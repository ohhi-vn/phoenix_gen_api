...
The complete path from WebSocket message to response, traced through the source. Use this as a debugging map: find the phase, open the file, follow the branches.
...
**File**: `lib/phoenix_gen_api/permission.ex`
